...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.chat": "對話",
    "settings.keepAlive": "活躍會話",
    "settings.keepAliveDescription": "切換對話時在背景保持靜默重新整理，切回無需重新載入；超過靜默期的會話自動移出活躍會話。",
    "settings.keepAliveMaxSessions": "活躍會話數",
    "settings.keepAliveIdleTimeout": "靜默自動關閉（分鐘）",
    ...
    "sidebar.sessionActionFailed": "重新命名或刪除失敗，請重試。",
    "sidebar.delete": "刪除",
    ...
    "chat.toolCategory.view": "讀取",
    "chat.toolCategory.search": "搜尋",
    "chat.toolCategory.edit": "編輯",
    "chat.toolCategory.terminal": "終端",
    "chat.toolCategory.subagent": "子代理",
    "chat.toolCategory.plan": "計劃",
    "chat.toolCategory.compact": "壓縮",
    "chat.toolCategory.web": "網路",
    "chat.toolCategory.other": "工具",
    "chat.activity.file": "{count} 個檔案",
    "chat.activity.files": "{count} 個檔案",
    "chat.activity.call": "{count} 次",
    "chat.activity.calls": "{count} 次",
    "chat.activity.subagentNotification": "子代理彙報",
    "chat.activity.failed": "執行失敗",
    "chat.question.pager": "問題 {index}/{total}",
    "chat.question.answered": "已回答",
    "chat.question.previous": "上一個問題",
    "chat.question.next": "下一個問題",
    "chat.question.answerLabel": "回答",
    "chat.question.answeredCancelled": "已取消",
    "chat.question.backToCurrent": "返回當前問題",
    "chat.question.reviewHint": "正在檢視已回答的問題，點 › 返回當前問題。",
    ...
    "chat.editQueued": "編輯",
    "chat.editQueuedTitle": "將該訊息取回輸入框編輯",
    ...
    "chat.moreControls": "更多",
    "chat.extensionStatus": "擴充",
    "chat.permissiveMode": "權限校驗已關閉",
    "chat.collapseControls": "收起控制項",
    "chat.shell": "Shell",
    "gitPanel.title": "Git",
    "gitPanel.selectRepository": "選擇儲存庫",
    "gitPanel.selectBranch": "選擇分支",
    "gitPanel.branch": "分支",
    "gitPanel.refresh": "重新整理儲存庫與歷史紀錄",
    "gitPanel.loading": "載入中…",
    "gitPanel.loadMore": "載入更多",
    "gitPanel.back": "返回",
    "gitPanel.retry": "重試",
    "gitPanel.error": "載入失敗：{message}",
    "gitPanel.emptyLog": "暫無提交",
    "gitPanel.emptyFiles": "該提交沒有變更檔案",
    "gitPanel.pushed": "已推送",
    "gitPanel.notPushed": "未推送",
    "gitPanel.filesChanged": "{count} 個檔案變更",
    "gitPanel.compareCommit": "與父提交對比",
    "gitPanel.truncated": "已截斷",
    "gitPanel.noRepositories": "未發現 git 儲存庫",
    "terminal.title": "終端機",
    ...
    "chat.commandAutoCompact": "切換自動上下文壓縮（全域設定）",
    ...
    "models.enableShown": "開啟篩選結果",
    "models.disableShown": "關閉篩選結果",
    ...
    "i18n.rename": "重新命名",
    "modelsConfig.providerNameTaken": "已存在同名 Provider",
    "modelsConfig.groupSignedIn": "已登入 Provider",
    "modelsConfig.groupCustom": "自訂 · models.json",
    "i18n.default": "預設",
    "i18n.disabled": "已停用",
