...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.chat": "對話",
    "settings.keepAlive": "對話保活",
    "settings.keepAliveDescription": "切換對話時在背景保持靜默重新整理，切回無需重新載入；超過靜默期的對話自動關閉保活。",
    "settings.keepAliveMaxSessions": "保活對話數",
    "settings.keepAliveIdleTimeout": "靜默自動關閉（分鐘）",
    "keepalive.title": "保活對話",
    "keepalive.label": "保活",
    "keepalive.close": "關閉保活",
    "keepalive.empty": "暫無保活對話",
