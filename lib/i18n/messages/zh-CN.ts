...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.chat": "对话",
    "settings.keepAlive": "会话保活",
    "settings.keepAliveDescription": "切换会话时在后台保持静默刷新，切回无需重新加载；超过静默期的会话自动关闭保活。",
    "settings.keepAliveMaxSessions": "保活会话数",
    "settings.keepAliveIdleTimeout": "静默自动关闭（分钟）",
    "keepalive.title": "保活会话",
    "keepalive.label": "保活",
    "keepalive.close": "关闭保活",
    "keepalive.empty": "暂无保活会话",
