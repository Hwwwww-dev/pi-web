...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.chat": "对话",
    "settings.keepAlive": "活跃会话",
    "settings.keepAliveDescription": "切换会话时在后台保持静默刷新，切回无需重新加载；超过静默期的会话自动移出活跃会话。",
    "settings.keepAliveMaxSessions": "活跃会话数",
    "settings.keepAliveIdleTimeout": "静默自动关闭（分钟）",
    ...
    "sidebar.sessionActionFailed": "重命名或删除失败，请重试。",
    "sidebar.delete": "删除",
    ...
    "chat.toolCategory.view": "读取",
    "chat.toolCategory.search": "搜索",
    "chat.toolCategory.edit": "编辑",
    "chat.toolCategory.terminal": "终端",
    "chat.toolCategory.subagent": "子代理",
    "chat.toolCategory.plan": "计划",
    "chat.toolCategory.compact": "压缩",
    "chat.toolCategory.web": "网络",
    "chat.toolCategory.other": "工具",
    "chat.activity.file": "{count} 个文件",
    "chat.activity.files": "{count} 个文件",
    ...
    "chat.question.previous": "上一个问题",
    "chat.question.next": "下一个问题",
    "chat.question.answerLabel": "回答",
    "chat.question.answeredCancelled": "已取消",
    "chat.question.backToCurrent": "返回当前问题",
    "chat.question.reviewHint": "正在查看已回答的问题，点 › 返回当前问题。",
    ...
    "chat.confirm": "确认",
    "chat.submit": "提交",
    "chat.extensionCustomAnswer": "自定义答案（不勾选选项时提交此项）",
    ...
    "chat.editQueued": "编辑",
    "chat.editQueuedTitle": "将该消息取回输入框编辑",
    ...
    "chatMinimap.locateAssistant": "跳转到这条回答",
    ...
    "chat.extensionStatus": "扩展",
    "chat.permissiveMode": "权限校验已关闭",
    ...
    "gitPanel.branch": "分支",
    "gitPanel.refresh": "刷新仓库与历史记录",
    "gitPanel.loading": "加载中…",
    "gitPanel.loadMore": "加载更多",
    "gitPanel.back": "返回",
    "gitPanel.retry": "重试",
    "gitPanel.error": "加载失败：{message}",
    "gitPanel.emptyLog": "暂无提交",
    "gitPanel.emptyFiles": "该提交没有变更文件",
    "gitPanel.pushed": "已推送",
    "gitPanel.notPushed": "未推送",
    "gitPanel.filesChanged": "{count} 个文件变更",
    "gitPanel.compareCommit": "与父提交对比",
    "gitPanel.truncated": "已截断",
    "gitPanel.noRepositories": "未发现 git 仓库",
    "terminal.title": "终端",
    ...
    "chat.currentToolPreset": "本轮使用的工具预设：{preset}",
    ...
    "modelsConfig.groupSignedIn": "已登录 Provider",
    "modelsConfig.groupCustom": "自定义 · models.json",
    "i18n.default": "默认",
    "i18n.disabled": "已禁用",
