...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.chat": "Chat",
    "settings.keepAlive": "Chat keep-alive",
    "settings.keepAliveDescription": "Switched sessions keep refreshing silently in the background so switching back is instant; sessions idle beyond the timeout stop being kept alive.",
    "settings.keepAliveMaxSessions": "Kept-alive sessions",
    "settings.keepAliveIdleTimeout": "Auto-close after idle (minutes)",
    "keepalive.title": "Kept-alive sessions",
    "keepalive.label": "Kept",
    "keepalive.close": "Stop keeping",
    "keepalive.empty": "No kept-alive sessions",
