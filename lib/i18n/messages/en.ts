...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.chat": "Chat",
    "settings.keepAlive": "Active chats",
    "settings.keepAliveDescription": "Switched sessions keep refreshing silently in the background so switching back is instant; sessions idle beyond the timeout are removed from active chats.",
    "settings.keepAliveMaxSessions": "Active chats",
    "settings.keepAliveIdleTimeout": "Auto-close after idle (minutes)",
    ...
    "sidebar.sessionActionFailed": "Rename or delete failed. Please try again.",
    ...
    "chat.toolCategory.view": "Read",
    "chat.toolCategory.search": "Search",
    "chat.toolCategory.edit": "Edit",
    "chat.toolCategory.terminal": "Terminal",
    "chat.toolCategory.subagent": "Sub-agent",
    "chat.toolCategory.plan": "Plan",
    "chat.toolCategory.compact": "Compact",
    "chat.toolCategory.web": "Web",
    "chat.toolCategory.other": "Tool",
    "chat.activity.file": "{count} file",
    "chat.activity.files": "{count} files",
    ...
    "chat.question.previous": "Previous question",
    "chat.question.next": "Next question",
    "chat.question.answerLabel": "Answer",
    "chat.question.answeredCancelled": "Answered (cancelled)",
    "chat.question.backToCurrent": "Back to current question",
    "chat.question.reviewHint": "Viewing an answered question — use › to return to the current one.",
    ...
    "chat.editQueuedTitle": "Take this message back into the input box for editing",
    ...
    "chat.moreControls": "More",
    "chat.extensionStatus": "Extensions",
    "chat.permissiveMode": "Permission checks are off",
    ...
    "gitPanel.refresh": "Refresh repository and history",
    "gitPanel.loading": "Loading…",
    "gitPanel.loadMore": "Load more",
    "gitPanel.back": "Back",
    "gitPanel.retry": "Retry",
    "gitPanel.error": "Failed to load: {message}",
    "gitPanel.emptyLog": "No commits yet",
    "gitPanel.emptyFiles": "No files changed in this commit",
    "gitPanel.pushed": "Pushed",
    "gitPanel.notPushed": "Not pushed",
    "gitPanel.filesChanged": "{count} files changed",
    "gitPanel.compareCommit": "Diff against the parent commit",
    "gitPanel.truncated": "truncated",
    "gitPanel.noRepositories": "No git repositories found",
    ...
    "i18n.rename": "Rename",
    "modelsConfig.providerNameTaken": "A provider with this name already exists",
    "modelsConfig.groupSignedIn": "Signed-in providers",
    "modelsConfig.groupCustom": "Custom · models.json",
